...
const page = () => {
  return (
    <div className="mx-auto max-w-screen-2xl  py-10 px-3  lg:h-full  lg:mb-40 lg:mt-20">
      ...
      <div className="mt-10">
        <p>
          Welcome to One Life Tourism!<br></br> These terms and conditions
          outline the rules and regulations for the use of One Life Tourism’s
          Website, located at https://onelifetourism.com. By accessing this
          website we assume you accept these terms and conditions. Do not
          continue to use One Life Tourism if you do not agree to take all of
          the terms and conditions stated on this page.<br></br> The following
          ...
          subject to, prevailing law of ae. Any use of the above terminology or
        ...
        <p className="mt-1">
          We employ the use of cookies. By accessing One Life Tourism, you
          agreed to use cookies in agreement with the One Life Tourism’s Privacy
        ...
        <p className="font-bold mt-8">License</p>
        <p className="mt-1">
          Unless otherwise stated, One Life Tourism and/or its licensors own the
          intellectual property rights for all material on One Life Tourism. All
          intellectual property rights are reserved. You may access this from
          One Life Tourism for your own personal use subjected to restrictions
          set in these terms and conditions.<br></br>You must not:
        </p>
        <ul className="ml-8">
          <li>Republish material from One Life Tourism</li>
          <li>Sell, rent or sub-license material from One Life Tourism</li>
          <li>Reproduce, duplicate or copy material from One Life Tourism</li>
          <li>Redistribute content from One Life Tourism</li>
        </ul>
        <p className="mt-1">
          This Agreement shall begin on the date hereof. Our Terms and
          Conditions were created with the help of the Free Terms and Conditions
          Generator. <br></br>Parts of this website offer an opportunity for
          users to post and exchange opinions and information in certain areas
          of the website. One Life Tourism does not filter, edit, publish or
          review Comments prior to their presence on the website. Comments do
          not reflect the views and opinions of One Life Tourism,its agents
          ...
          applicable laws, One Life Tourism shall not be liable for the Comments
          ...
          Comments on this website.<br></br> One Life Tourism reserves the right
          ...
          and Conditions.<br></br> You warrant and represent that:
        </p>
        <ul className="ml-8">
          <li>
        ...
        <p className="mt-1">
          You hereby grant One Life Tourism a non-exclusive license to use,
          reproduce, edit and authorize others to use, reproduce and edit any of
          your Comments in any and all forms, formats or media.
        </p>
        <p className="font-bold mt-8">Hyperlinking to our Content</p>
        <p className="mt-1">
        ...
        <p className="mt-1">
          ...
          the hyperlink compensates the absence of One Life Tourism; and (d) the
          ...
          sending an e-mail to One Life Tourism. Please include your name, your
