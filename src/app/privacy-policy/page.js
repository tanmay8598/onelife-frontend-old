  ...
  return (
    <div className="mx-auto max-w-screen-2xl  py-10 px-3  lg:h-full  lg:mb-40 lg:mt-20">
      <p className="font-bold text-3xl">
        Privacy Policy for One Life Tourism LLC
      </p>

      <div className="mt-10">
        <p>
          At onelifetourism.com, accessible from https://onelifetourism.com, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by onelifetourism.com and how we use it. If you have
          ...
          onelifetourism.com. This policy is not applicable to any information
          collected offline or via channels other than this website.
        </p>

        <p className="font-bold mt-8">Consent</p>
        <p className="mt-1">
          By using our website, you hereby consent to our Privacy Policy and
          agree to its terms.
        </p>
        <p className="font-bold mt-8">Information we collect</p>
        <p className="mt-1">
        ...
        <p className="font-bold mt-8">How we use your information</p>
        <p className="mt-1">
